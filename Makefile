...
SRC:=$(GOPATH)/src/github.com/ripoUGC/reporter
...
.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/ripoUGC/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t ripoUGC/grafana-reporter:2.3.0 -t ripoUGC/grafana-reporter:latest .

docker-push:
	@docker push ripoUGC/grafana-reporter
